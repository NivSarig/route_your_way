...
if __name__ == "__main__":
    ...
    raw_durations = """  0  273    0 1272  999    0  744  809 1519    0 1138  866  140 1425
    ...
    durations_raw_lines_of_16 = [l.split("  ") for l in raw_durations.split('\n')]
    ...
    EOF
        ...
        """.format(name, dimension, durations)
